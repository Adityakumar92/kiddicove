...
export default function Programs() {
    var _a = useState(false), isContactModalOpen = _a[0], setIsContactModalOpen = _a[1];
    var _b = useState(""), selectedService = _b[0], setSelectedService = _b[1];
    var openContactModal = function (service) {
